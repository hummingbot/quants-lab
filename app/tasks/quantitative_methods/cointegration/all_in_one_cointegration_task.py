...
from app.tasks.data_collection.funding_rates_task import FundingRatesTask
from app.tasks.quantitative_methods.cointegration.cointegration_task import CointegrationTask
from app.tasks.quantitative_methods.cointegration.stat_arb_config_generator_task import StatArbConfigGeneratorTask
